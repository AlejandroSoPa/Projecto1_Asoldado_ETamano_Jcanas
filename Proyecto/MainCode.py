    ...
    if opt == 1:
                        ...
                        if id_char == 0:
                            ...
                            while flag_adv:
                                ...
                                if bystep_adventure[id_step]["Final_Step"] == 1:
                                    ...
                                    print(f.formatText(answers_bystep_adventure[(answer, id_step)]["Resolution_answer"], 100))
                                    f.wait()
        ...
        while flag_replay:
            ...
            if len(replayAdventures) <= 5:
                print(f.getHeaderForTableFromTuples(("ID", "User", "Adventure", "Character", "Date"), (5, 10, 50, 20, 20), "Adventures"))
                print(f.getTableFromDict(("Username", "Name", "CharacterName", "date"), (10, 50, 20, 20), replayAdventures))
                id_replay = int(f.getOpt("\n",
                                     "Which Adventure do you want to replay (0 to Go Back) ",
                                     [], replayAdventures, [0]))
                if id_replay == 0:
                    flag_replay = False
                else:
            ...
            if opt == 1:
                ...
                while True:
                    ...
                    if f.checkUserbbdd(user, " ") == 0:
                        ...
                        break
                header = "TOP 5 GAMES PLAYED BY " + str(user).upper()
                ...
                break
            print(f.getFormatedTable(f.getTable(query), header))
            f.wait()
    else:
        flag_title = False